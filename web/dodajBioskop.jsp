                ...
                <div class="col-md-8">
                    ...
                    <form action="dodajBioskop" method="post">
                        <div class="form-group">
                            ...
                            <input name="nazivBioskopa" type="text" class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Adresa: </label>
                        ...
                        <div class="form-group">
                            <label>Opis: </label>
                            <textarea name="opis" class="form-control" cols="40" maxlength="400"></textarea>
                        </div>
                        <div class="form-group">
                        ...
                        <input type="submit" class="btn btn-primary" value="Dodaj bioskop">
